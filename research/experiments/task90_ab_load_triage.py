...
def main() -> None:
    ...
    print("    which neurons win and so is a load-gap candidate, and none can")
    print("    be measured here until the emergent parser runs on numpy_exact")
    print("    (blocked: it uses LRI/refractory, which that engine rejects).")
