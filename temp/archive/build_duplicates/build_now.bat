@echo off
echo 🚀 BUILDING CUDA KERNELS FOR RTX 4090
echo ====================================
...
echo.
echo Now building neural simulation kernels...

echo Compiling CUDA kernels...
nvcc -c cuda_kernels.cu -o cuda_kernels.obj --compiler-options /MD -O3 --use_fast_math -arch=sm_75
if errorlevel 1 (
...
nvcc -c cuda_brain.cu -o cuda_brain.obj --compiler-options /MD -O3 --use_fast_math -arch=sm_75
if errorlevel 1 (
