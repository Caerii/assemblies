...
def test_cuda_minimal():
    """Test the minimal CUDA DLL"""
    print("🚀 TESTING MINIMAL CUDA DLL")
    print("=" * 50)
    
    try:
        # Load the minimal CUDA DLL
        dll = ctypes.CDLL('cuda_minimal.dll')
        ...
        print("✅ Minimal CUDA DLL loaded successfully!")
        ...
        print(f"\n🎉 MINIMAL CUDA DLL TEST COMPLETE!")
        
    except Exception as e:
        print(f"❌ Minimal CUDA DLL test failed: {e}")
        import traceback
        traceback.print_exc()
