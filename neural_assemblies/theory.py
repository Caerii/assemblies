...
_RESULTS: List[Result] = [
    ...
    Result(
        ...
        caveat="Expansion and quantization are a PAIR. Amplification alone is "
               ...
               "strength with zero margin, and the soft pairs are the price of "
               "the conjunction. The transducer at half beta is worse on every "
               "count (A3 Amendment 2), so its null is structural. Apparent group "
