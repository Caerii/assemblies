...
```python
from neural_assemblies.simulation import project_sim, merge_sim, association_sim, pattern_com
from neural_assemblies.simulation import plot_project_sim, plot_merge_sim
...
- [neural_assemblies/core](../core/README.md) — Brain and engines used by these sims.
