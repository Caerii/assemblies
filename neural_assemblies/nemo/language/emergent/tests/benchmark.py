...
def benchmark_brain_operations():
    ...
    from neural_assemblies.nemo.language.emergent.brain import EmergentNemoBrain
    from neural_assemblies.nemo.language.emergent.params import EmergentParams
    from neural_assemblies.nemo.language.emergent.areas import Area
...
def benchmark_learner_operations():
    ...
    from neural_assemblies.nemo.language.emergent.params import EmergentParams, GroundingContext
...
def benchmark_sentence_processing():
    ...
    from neural_assemblies.nemo.language.emergent.learner import EmergentLanguageLearner
    from neural_assemblies.nemo.language.emergent.params import EmergentParams
    from neural_assemblies.nemo.language.emergent.training_data import create_training_data
...
def benchmark_parsing():
    ...
    from neural_assemblies.nemo.language.emergent.params import EmergentParams
    from neural_assemblies.nemo.language.emergent.training_data import create_training_data
    from neural_assemblies.nemo.language.emergent.parser import SentenceParser
