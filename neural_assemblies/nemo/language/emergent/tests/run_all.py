...
def main():
    ...
    from neural_assemblies.nemo.language.emergent.tests.shared_model import get_trained_learner, get_training_time
    learner = get_trained_learner(epochs=3)
    
    # Import and run each test module with shared learner
    from neural_assemblies.nemo.language.emergent.tests import test_training
    from neural_assemblies.nemo.language.emergent.tests import test_parser
    from neural_assemblies.nemo.language.emergent.tests import test_comprehension
