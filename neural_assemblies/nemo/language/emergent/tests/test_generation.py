...
from neural_assemblies.nemo.language.emergent.curriculum import get_training_curriculum
from neural_assemblies.nemo.language.emergent.generation import EmergentGenerator, VPDecoder, ActivationSpreader
...
def test_comparison(learner):
    ...
    from neural_assemblies.nemo.language.emergent.parser.comprehension import QuestionAnswerer
