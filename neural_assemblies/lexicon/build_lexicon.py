...
from neural_assemblies.lexicon.lexicon_manager import LexiconManager, Word, WordCategory, SemanticDomain
from neural_assemblies.lexicon.statistics import WordStatistics, WordStats

# Import word data
from neural_assemblies.lexicon.data.nouns import NOUNS
from neural_assemblies.lexicon.data.verbs import VERBS
from neural_assemblies.lexicon.data.adjectives import ADJECTIVES
from neural_assemblies.lexicon.data.adverbs import ADVERBS
from neural_assemblies.lexicon.data.determiners import DETERMINERS
from neural_assemblies.lexicon.data.prepositions import PREPOSITIONS
from neural_assemblies.lexicon.data.pronouns import PRONOUNS
from neural_assemblies.lexicon.data.conjunctions import CONJUNCTIONS
from neural_assemblies.lexicon.data.auxiliaries import AUXILIARIES
