...
class IncrementalMixin:
    ...
    if TYPE_CHECKING:
        ...
        def parse_roles_by_reconstruction(self, words: List[str], filler_word: Optional[str] = None, filler_role: Optional[str] = None) -> Tuple[Dict[str, Optional[str]], Dict[str, Any]]: ...
