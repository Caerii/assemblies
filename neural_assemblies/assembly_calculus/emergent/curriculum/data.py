...
def create_instruction_sentences() -> List[GroundedSentence]:
    """Imperative and short dialogue sentences for agent / tool training."""
    data = []

    # ---- Imperatives: VERB DET NOUN (implicit addressee) ----
    imperatives = [
        (["chases", "the", "cat"], [None, None, "patient"]),
        (["chases", "the", "bird"], [None, None, "patient"]),
        (["finds", "the", "dog"], [None, None, "patient"]),
        (["sees", "the", "boy"], [None, None, "patient"]),
        (["reads", "the", "book"], [None, None, "patient"]),
    ]
    for words, roles in imperatives:
        data.append(GroundedSentence(
            words=words,
    ...
    # ---- Interrogatives for chat Q-A ----
    data.append(GroundedSentence(
        words=["who", "chases", "the", "cat"],
        contexts=[_ctx("who"), _ctx("chases"), _ctx("the"), _ctx("cat")],
        roles=[None, "action", None, "patient"],
        mood="interrogative",
    ))
    data.append(GroundedSentence(
        words=["who", "sees", "the", "bird"],
        contexts=[_ctx("who"), _ctx("sees"), _ctx("the"), _ctx("bird")],
        roles=[None, "action", None, "patient"],
        mood="interrogative",
    ))
