...
def parse(sentence="cats chase mice", language="English", p=0.1, LEX_k=20,
          non_LEX_n=1000, project_rounds=30, verbose=True, debug=False,
          readout_method=ReadoutMethod.FIBER_READOUT, engine="auto"):
    """
    ...
    """
    if language == "English":
        b = EnglishParserBrain(p, non_LEX_n=non_LEX_n, LEX_k=LEX_k, verbose=verbose, engine=engine)
...
def parseHelper(b, sentence, project_rounds, verbose, debug, 
    ...
    b.area_lexeme_cache = {}
    b._outer_lexeme_cache = {}
    b._inner_lexeme_cache = {}
    b._in_dep_clause = False
