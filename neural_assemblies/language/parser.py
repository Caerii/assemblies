...
from .language_areas import (
    LEX, DET, SUBJ, OBJ, VERB, PREP, PREP_P, ADJ, ADVERB, DEP_CLAUSE, NOM, ACC, DAT, LEX_SIZE, RUSSIAN_LEX_SIZE, DET_SIZE, DISINHIBIT, INHIBIT, ACTIVATE_ONLY, CLEAR_DET, AREAS, EXPLICIT_AREAS, RECURRENT_AREAS, RUSSIAN_AREAS, RUSSIAN_EXPLICIT_AREAS, ENGLISH_READOUT_RULES, RUSSIAN_READOUT_RULES,
)
