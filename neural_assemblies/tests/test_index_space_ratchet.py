...
W_BASELINE = {
    ...
    # Compiled CONTEXT ring rewind, mirrored to descriptor and owner.
    "neural_assemblies/assembly_calculus/emergent/training/linker.py": 2,
    ...
    # Compiled role-ring rewind, mirrored to descriptor and owner.
    "neural_assemblies/assembly_calculus/emergent/parser_mixins/unsupervised.py": 2,
